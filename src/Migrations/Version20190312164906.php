 ...
 */
final class Version20190312164906 extends AbstractMigration {
  ...
  public function up(Schema $schema) : void {
    ...
    $this->addSql('CREATE TABLE programmer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nickname VARCHAR(100) NOT NULL, avatar_number INT NOT NULL, tag_line VARCHAR(255) DEFAULT NULL, power_level INT NOT NULL DEFAULT 0, UNIQUE INDEX UNIQ_4136CCA9A188FE64 (nickname), INDEX IDX_4136CCA9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
